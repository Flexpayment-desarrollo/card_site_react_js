...
export const GoogleNIP = ({ keyDetect, enter, login, autofocus }) => {
                    ...
                    <Grid container>
                        <Grid item xs={3} sm={3}>
                            <input
                                ...
                                style={{ width: "38px", height: "42px", borderRadius: "5px", border: "1.5px solid lightGray", textAlign: "center", fontSize: "20px" }}
                                size='small'
